  ...
  <div class="site-container site-header__inner">
    <div class="site-header__bar">
      ...
      <button
        ...
        aria-label="<?php esc_attr_e('Open navigation menu', 'havenstone'); ?>"
      >
    ...
    <a class="site-header__cta button button--small" href="<?php echo esc_url(home_url('/request-a-property/')); ?>">
      Request a Property
    </a>
  </div>
</header>
